...
/**
 * Script sederhana untuk test login dengan PIN 666666
 * Jalankan dengan: php simple_login_test.php
 * Pastikan web server sudah berjalan di http://localhost:8000
 */

echo "=== SIMPLE LOGIN TEST DENGAN PIN 666666 ===\n\n";
...
// Perform login - menggunakan /panel/login bukan /panel/verify
$ch = curl_init($baseUrl . '/panel/login');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
